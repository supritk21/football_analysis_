...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub = False, stub_path = None):
        ...
        tracks = {
            "player": [],  #conttain bounding box for the players
            "referee": [],
            "ball": []
        }

        for frame_num, detection in enumerate(detections):
            cls_names =  detection.names   #cls_names = {'0': 'goalkeeper', '1': 'player'}
            cls_names_inv = {v: k for k, v in cls_names.items()}  #cls_names_inv = {'goalkeeper': '0',

            #convert to supervise Detection Formate
            ...
            # print("class names",cls_names_inv["goalkeeper"])
